          ...
          <tbody className="text-white">
            {filteredData.length > 0 ? (
              filteredData.map((item) => {
                ...
                const twentyFourHour = parseFloat(item.twentyFourHour.replace("%", ""));
                ...
                return (
                  ...
                  >
                    ...
                    <td className={`px-6 py-4 ${oneHour < 0.22 ? 'text-red-500' : 'text-green-300'}`}>{item.oneHour}</td>
                    <td className={`px-6 py-4 ${twentyFourHour < 6 ? 'text-red-500' : 'text-green-300'}`}>{item.twentyFourHour}</td>
                    <td className={`px-6 py-4 ${sevenDay < 9 ? 'text-red-500' : 'text-green-300'}`}>{item.sevenDay}</td>
                    <td className={`px-6 py-4 ${oneMonth < 9 ? 'text-red-500' : 'text-green-300'}`}>{item.oneMonth}</td>
