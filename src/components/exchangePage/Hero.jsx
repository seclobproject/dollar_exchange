      ...
      <div className="absolute inset-0 flex justify-center items-center">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-4">
            ...
            <p className="text-xl md:text-2xl mt-0 md:mt-1  lg:text-4xl xl:text-6xl font-semibold bg-clip-text text-transparent bg-custom-gradient ">3.67 AED</p>
            <h1 className="text-md md:text-xl lg:text-xl xl:text-2xl md:mt-1 xs:font-medium font-normal text-white ">1 USDT = 3.67 AED</h1>
          </div>
        </div>
      </div>
    </div>
